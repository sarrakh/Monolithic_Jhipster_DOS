...
import tn.isi.monoapp.domain.Department;
import tn.isi.monoapp.repository.DepartmentRepository;
...
/**
 * REST controller for managing {@link tn.isi.monoapp.domain.Department}.
 */
@RestController
@RequestMapping("/api")
@Transactional
