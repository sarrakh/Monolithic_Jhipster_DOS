...
import tn.isi.monoapp.domain.Employee;
import tn.isi.monoapp.repository.EmployeeRepository;
...
public class EmployeeResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "AAAAAAAAAAAAAAA";
    private static final String UPDATED_EMAIL = "BBBBBBBBBBBBBBB";
    ...
    @Test
    @Transactional
    public void checkCommissionPctIsRequired() throws Exception {
        int databaseSizeBeforeTest = employeeRepository.findAll().size();
        // set the field null
