package tn.isi.monoapp.repository;

import tn.isi.monoapp.MonoAppSoaApp;

import tn.isi.monoapp.config.Constants;
import tn.isi.monoapp.config.audit.AuditEventConverter;
import tn.isi.monoapp.domain.PersistentAuditEvent;
...
import static tn.isi.monoapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
